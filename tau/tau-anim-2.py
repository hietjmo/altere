...
# ffmpeg -y -framerate 30 -i frames/frame-%06d.png -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p tau-anim-1.mp4
...
nms = "9876543210."
tau_str = [c for c in tau_cent if c in nms]
...
ysurf ["."] = nms.index (tau_str[0]),surfaces[10]
