...
def draw_archie (x,y,r):
  ...
  ranges = list (np.arange (0.0,pi))
  for i,(a,b) in enumerate  (zip (ranges[0:],ranges[1:]+[pi])):
...
def draw_ticks ():
  ...
  ranges = list (np.arange (0.0,pi,1.0)) + [pi]
  for i,a in enumerate (ranges):
    a = a - rot_zero
    # print (i,a,b)
    draw_tick (center_x,center_y,circle_r-5,circle_r+5,a)
  draw_tick (center_x,center_y,circle_r-5,circle_r+5,pi)
  ct.stroke ()
...
def draw_r ():
  ...
  pt3 = add ((center_x, center_y), polar_xy (circle_r-10,phi2))
  ct.move_to (*pt1)
  ct.line_to (*pt3)
  ct.stroke ()
...
def draw_numbers ():
  ranges = list (np.arange (0.0,pi,1.0))
  for i,a in enumerate (ranges):
    a = a - rot_zero
    # print (i,a,b)
...
surface.write_to_png("insidium-half-pi.png")
